...
<html>
    ...
    <body>
        ...
        <ul>
            <li><a href="?action=listerLesUtilisateurs">Afficher/raffraichir la liste de tous les utilisateurs</a></li>
            <p>
        </ul>
        ...
        <ol>
            <li><a href="?action=creerUtilisateursDeTest">Créer 4 utilisateurs de test</a></li>
